...
int64 nChainStartTime = 1408463751;
...
const string strMessageMagic = "bitcash Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    } else if(nHeight >= 2 && nHeight <= 14400) {
    nSubsidy = 0.01 * COIN;
    } else if(nHeight >= 14401 && nHeight <= 24480) {
    nSubsidy = 100 * COIN;
    } else if(nHeight >= 24481 && nHeight <= 34560) {
    nSubsidy = 50 * COIN;
    } else if(nHeight >= 34561 && nHeight <= 44640) {
    nSubsidy = 25 * COIN;
    } else if(nHeight >= 44641 && nHeight <= 54720) {
    nSubsidy = 12 * COIN;
    } else if(nHeight >= 54721 && nHeight <= 64800) {
    nSubsidy = 6 * COIN;
    } else if(nHeight >= 64801 && nHeight <= 1055520) {
    nSubsidy = 3 * COIN;
    }
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in bitcash
    bool fStrictPayToScriptHash = true; // Always active in bitcash
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "bitcash", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "BitCash - decentralized cryptocoin, for the people! 18/8/2014";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0x1cb87cc48eeaa59ac437ac1780e7355fbe090abe5f14e10700cba2189c05ebe5"));
